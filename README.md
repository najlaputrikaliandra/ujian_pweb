...
1. pastikan xampp sudah nyala.
2. run di terminal folder manga-project:
   - npm install (install jika baru pertama kali).
   - npx tailwindcss init -p (install jika baru pertama kali).
   - npm run dev (untuk nge jalanin server, pake perintah ini seterusnya).
